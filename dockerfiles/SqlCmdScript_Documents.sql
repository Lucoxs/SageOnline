...
CREATE DATABASE [IdentityConfig]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'IdentityConfig', FILENAME = N'C:\Users\lstro\IdentityConfig.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'IdentityConfig_log', FILENAME = N'C:\Users\lstro\IdentityConfig_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
